...
export default function FlashInput({ words, onComplete, onSkip, onBack }) {
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 10, padding: '12px 16px 0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
          ...
          {onBack && (
            <button onClick={e => { e.stopPropagation(); window.speechSynthesis?.cancel(); onBack(); }} style={{
          ...
          <button onClick={e => { e.stopPropagation(); window.speechSynthesis?.cancel(); onSkip(); }} style={{
